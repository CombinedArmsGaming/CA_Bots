...
slack_client = SlackClient('INSERT_TOKEN_HERE')
...
def handle_command(command, channel):
    ...
    """
    response = "I need more information to allocate additional fire support Parker, try the commands build repo or update repo if you need to call for additional support."
